...
* instâncias da classe String a partir do teclado. Basicamente esta classe
* encapsula o funcionamento do Stream System.in, que pode ser usado como
* entrada padrão de dados.
*
* Esta classe é baseada na classe EasyIn, de Peter van der Linden. As
* principais modificações foram:
*
*
Os métodos são estáticos para facilitar o uso da classe
*
Criação de métodos sobrecarregados para que valores default possam ser
* usados
*
...
*
* A classe permite o uso de arquivos de respostas ("answer files"), que são
...
* tivermos uma aplicação (classe) DemoDataKeyboard e quisermos usar um arquivo
* de respostas chamado dados.dat que já contém os dados que devem ser
...
* também apresenta uma classe Keyboard, cujo funcionamento e código são
* diferentes desta.
*
...
/**
* O método getToken lê uma string do BufferedReader associado com
* a entrada padrão e retorna uma instância de StringTokenizer contendo os
* tokens criados a partir da linha lida. O método é declarado como
* private pois só deverá ser chamado a partir de outros métodos da classe.
* @return uma instância de StringTokenizer contendo os tokens
...
/**
* O método readBoolean lê e retorna um valor do tipo boolean.
* Este método simplesmente chama o método readBoolean com argumentos,
...
/**
* O método readBoolean lê e retorna um valor do tipo boolean. Este
* método tenta pegar o próximo token a ser lido da entrada padrão e o compara
* com algumas strings constantes para verificar a igualdade, retornando true
* ou false dependendo do resultado da comparação.
...
/**
* O método readByte lê e retorna um valor do tipo byte. Este
* método simplesmente chama o método readByte com argumentos, descrito
...
/**
* O método readByte lê e retorna um valor do tipo byte. Este
* método tenta pegar o próximo token a ser lido da entrada padrão e o
* passa como argumento para o método parseByte da classe Byte,
* que tenta convertê-lo. Se a leitura e conversão puderem ser feitas, um valor
* do tipo byte é retornado, caso contrário o valor default
* (passado como argumento) é retornado.
* @param defaultvalue o valor default caso não seja possível ler e
...
/**
* O método readShort lê e retorna um valor do tipo short.
* Este método simplesmente chama o método readShort com argumentos,
...
/**
* O método readShort lê e retorna um valor do tipo short. Este
* método tenta pegar o próximo token a ser lido da entrada padrão e o passa
* como argumento para o método parseShort da classe Short, que
* tenta convertê-lo. Se a leitura e conversão puderem ser feitas, um valor do tipo
* short é retornado, caso contrário o valor default (passado
...
/**
* O método readInt lê e retorna um valor do tipo int. Este
* método simplesmente chama o método readInt com argumentos, descrito
...
* O método readInt lê e retorna um valor do tipo int. Este
* método tenta pegar o próximo token a ser lido da entrada padrão e o
* passa como argumento para o método parseInt da classe Integer,
* que tenta convertê-lo. Se a leitura e conversão puderem ser feitas, um valor
* do tipo int é retornado, caso contrário o valor default
* (passado como argumento) é retornado.
* @param defaultvalue o valor default caso não seja possível ler e
...
/**
* O método readLong lê e retorna um valor do tipo long. Este
* método simplesmente chama o método readLong com argumentos, descrito
...
* O método readLong lê e retorna um valor do tipo long. Este
* método tenta pegar o próximo token a ser lido da entrada padrão e o
* passa como argumento para o método parseLong da classe Long,
* que tenta convertê-lo. Se a leitura e conversão puderem ser feitas, um valor
* do tipo long é retornado, caso contrário o valor default
* (passado como argumento) é retornado.
* @param defaultvalue o valor default caso não seja possível ler e
...
/**
* O método readFloat lê e retorna um valor do tipo float. Este
* método simplesmente chama o método readFloat com argumentos, descrito
...
* O método readFloat lê e retorna um valor do tipo float. Este
* método tenta pegar o próximo token a ser lido da entrada padrão e o
* analisa, verificando se aparentemente é NaN ou infinito. Se não for,
* passa o valor lido como argumento para o método parseFloat da classe
* Float, que tenta convertê-lo. Se a leitura e conversão puderem ser
* feitas, um valor do tipo float é retornado, caso contrário o valor
...
/**
* O método readDouble lê e retorna um valor do tipo double.
* Este método simplesmente chama o método readDouble com argumentos,
...
/**
* O método readDouble lê e retorna um valor do tipo double. Este
* método tenta pegar o próximo token a ser lido da entrada padrão,
* analisando o valor para ver se é NaN ou infinito, e se não for, usa o
* valor como argumento para o método parseDouble da classe Double,
* que tenta convertê-lo. Se a leitura e conversão puderem ser feitas, um valor
* do tipo double é retornado, caso contrário o valor default
* (passado como argumento) é retornado.
* @param defaultvalue o valor default caso não seja possível ler e
...
/**
* O método readChar lê e retorna um valor do tipo char. Este
* método simplesmente chama o método readChar com argumentos, descrito
* abaixo, considerando o valor default como sendo ' ' (espaço).
...
/**
* O método readChar lê e retorna um valor do tipo char. Este
* método tenta pegar o próximo token a ser lido da entrada padrão e retorna
* o primeiro caractere deste token, ignorando os outros. Se a leitura puder ser
* feita, um valor do tipo char é retornado, caso contrário o valor
* default (passado como argumento) é retornado.
...
/**
* O método readString lê e retorna uma instância da classe String.
* Este método simplesmente chama o método readString com argumentos, descrito
...
* tokens. Se a leitura puder ser feita, a string lida é retornada, caso
* contrário o valor default (passado como argumento) é retornado. O valor
* default também é retornado no caso de uma string vazia.
* @param defaultvalue o valor default caso não seja possível ler uma instância
* da classe String
...
/**
* O método debugOn modifica o campo que indica que mensagens de erro
...
/**
* O método debugOff modifica o campo que indica que mensagens de erro
